...
void Cassa::handleMessage(cMessage *msg)
{
    ...
    if(msg->isSelfMessage()){
        ...
        simtime_t queueEnteringTime = ((Customer*) customers[0])->getArrivalTime();
    ...
    if(customers.size() > 0 && !isWorking){
        ...
        scheduleAt(simTime()+omnetpp::exponential(rng, getParentModule()->par("mu").longValue()), new cMessage());
